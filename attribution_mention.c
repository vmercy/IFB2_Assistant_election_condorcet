...
void attribution_mention(int *init, int nb_cand, char noms_candidats[50][51], char mentions_possibles[6][12], char mentions_jug_maj[50])
{
    int pos=0;
    char nom_saisi[51];
    strcpy(nom_saisi,"");
    printf("\nSaisissez le nom du candidat a qui vous voulez attribuer une mention : ");
    gets(nom_saisi);
    ...
    *init=1;
    ...
    printf("\nVoici les mentions que vous pouvez choisir : \n");
